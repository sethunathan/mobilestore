        ...
        <div style="padding-left:30px;" class="col-md-8 col-xs-12">
            ...
            <div style="padding-top: 10px">
                <table class="table table-bordered mt-5">
                    ...
                    @else
                        <tr><td colspan="8"><h5>No companies found</h5></td></tr>
                    @endif
                </table>
                ...
                <div class="card-body" style="padding-top: 10px">
                    <form wire:submit.prevent="store">
                        <div class="form-group">
                            ...
                            @error('concern_name') <span class="text-danger">{{ $message }}</span> @enderror
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            @error('udayam_reg_no') <span class="text-danger">{{ $message }}</span> @enderror
                        </div>
                        <div class="form-group">
